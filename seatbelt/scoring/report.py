...
from seatbelt._version import __version__ as SEATBELT_VERSION
...
class AuditReport:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "seatbelt_version": SEATBELT_VERSION,
    ...
    def to_markdown(self) -> str:
        ...
        lines.append(
            f"\n---\n*Generated by [Seatbelt](https://github.com/mishi93999/seatbelt) v{SEATBELT_VERSION}*"
        )
        return "\n".join(lines)
